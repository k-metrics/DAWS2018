...
　  
第３回で行った演習の解答例です。必ずしもこのコードが最適という訳ではありませんので参考程度に利用してください。なお、勉強会当日とコードを変えてあるものもあります。  
　  
...
## Tips
### cumulative関数
cumulative関数は累積、累計（累和）などを計算するウィンドウ関数と言われるものです。
```{r}
cumsum(1:10)
cumprod(1:10)
...
# **注意**
以降はdplyrやtidyrの基本動作を理解した上で演習してください。  
　  
