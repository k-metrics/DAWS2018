...
## 動作確認
### ブランチの作成
プロジェクトがインポートされたらGitのブランチを作成しておきます。［Git］タブの［New Branch］をクリックして以下のダイアログが表示されたらブランチ名として「feature/test」と入力し、**チェックボックスを外し**［Create］ボタンをクリックします。

![](./fig/RStudio_git_blanch.png)

　  
「master」の表示が「feature/test」に変わっていることを確認してください。
