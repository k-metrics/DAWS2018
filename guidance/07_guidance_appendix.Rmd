...
## DOMとは
Document Object Modelの略でHTMLドキュメントやXMLドキュメントをプログラムから利用するための仕組みで、 [Web Hypertext Application Technology Working Group (WHATWG) <i class="fa fa-external-link"></i>](https://whatwg.org/){target="_blank" title="Maintaining and evolving HTML since 2004"} が仕様を定義しています。
