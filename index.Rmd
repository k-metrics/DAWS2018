...
[第6回](#S06) | 2018/11/17 | 実践チケット分析          | Redmine
[第7回](#S07) | 2018/12/15 | データインポート演習      | rvest
[第8回](#S08) | 2019/1/12 | 調整中                     | （Ｏ島さんネタ？）
...
[Redmineからデータ取得する。 <i class="fa fa-external-link-square"></i>](./guidance/06_guidance_am.html){target="_blank" title="ioslide"}
...
ダッシュボードの[サンプル <i class="fa fa-external-link-square"></i>](guidance/06_dashboard.html) {target="_blank" title="ioslide"}  
...
* 実際にダッシュボードを作ってみる。  
[演習用テンプレート <i class="fa fa-file-code-o"></i> （右クリックでダウンロード）](./template/06_guidance_template.Rmd)
