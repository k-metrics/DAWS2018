...
* [Rではじめる多変量解析 <i class="fa fa-external-link"></i>](./guidance/09_guidance.html){target="_blank" title="ioslides"}
    * 重回帰分析
    * 主成分分析
    * 因子分析
    * クラスタ分析など
    * 演習＆発表
* （準備中）
* [来年度に向けて <i class="fa fa-external-link"></i>](./guidance/GoogleSites.html){target="_blank" title="ioslides"}
...
[Rではじめる多変量解析 - 右クリックで保存（zip形式） <i class="fa fa-file-archive-o"></i>](./guidance/09_guidance.zip){target="_blank" title="zip形式"}
