...
[第8回](#S08) | 2019/1/12 | 今までの学びを振り返る     | -
[第9回](#S09) | 2019/1/12 | Rで学ぶ多変量解析          | 会場が異なります
...
年明けの第8回は昨年、学んできましたモダンなRの世界を振り返る回です。振り返ることでモダンなRを自分のものにしましょう。加えて関連事項を学んでいきます。  
　  
...
## 第9回 Rで学ぶ多変量解析 {#S09}
最終回は次年度への足がかりの一つとして多変量解析を取り上げます。多変量解析は実際の現場で遭遇することも多いと思います。まずは入門レベルとして古典的な多変量解析を学びましょう。  
なお、会場の都合上、ネット接続環境は使えませんので座学形式となります。ネット接続環境が必要な方はご自身でご準備をお願いします。  
　  
