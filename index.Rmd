...
勉強会初（勉強会としては本邦初？）の試みとしてGitHubリポジトリと**`packrat`**パッケージを用いた統一環境の作成を試します。途中、上手く行かない可能性もありますが、ご了承ください。  
　  
...
* [自己紹介テンプレート <i class="fa fa-external-link-square"></i>](./guidance/Self-introduction.html){target="_blank" title="ioslide"}
* [自己紹介テンプレート（右クリックでダウンロード）](./guidance/Self-introduction.Rmd)
...
* [演習用テンプレート <i class="fa fa-external-link-square"></i>](./guidance/template.html){target="_blank" title="HTML Format"}
* [演習用テンプレート（右クリックでダウンロード）](./guidance/template.Rmd)
