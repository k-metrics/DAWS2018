...
* [Seleniumハンズオン <i class="fa fa-external-link-square"></i>](./guidance/08_guidance_RSelenium.html){target="_blank" title="RSelenium"}
    ...
    * [Seleniumのインストール補助資料（Windows環境のみ） <i class="fa fa-external-link-square"></i>](./guidance/08_guidance_setup_java.html){target="_blank" title="ioslids"}
...
* [Kibanaハンズオン(PDF) <i class="fa fa-external-link-square"></i>](./guidance/08_guidance_kibana.pdf){target="_blank" title="PDF"}
    * リアルタイムで更新できる可視化ツールKibanawo使ってみましょう
